...
// Funkcja przejmująca logi, którą możesz zaimportować lub używać w bot.js
...
module.exports = function(client) {
    ...
    // Trasa panelu WWW z wbudowanym terminalem 1:1
    router.get('/panel', (req, res) => {
        res.send(`
            ...
            <head>
                ...
                <title>Centrum Dowodzenia - Terminal Bota</title>
                <style>
                    body {

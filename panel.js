                ...
                <div class="card">
                    ...
                    <form action="/send-embed" method="POST">
                        <div class="form-group">
                            <label>ID Kanału docelowego na Discordzie</label>
                            <input type="text" name="channelId" placeholder="Wklej ID kanału..." required>
                        </div>
                        <div class="form-group">
...
router.post('/send-embed', express.urlencoded({ extended: true }), async (req, res) => {
    ...
    try {
        if (!botClient) {
            console.log('[BŁĄD PANELU] Klient bota nie jest jeszcze gotowy.');
